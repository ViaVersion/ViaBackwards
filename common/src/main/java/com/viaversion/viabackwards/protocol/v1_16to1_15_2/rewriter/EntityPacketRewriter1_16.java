...
public class EntityPacketRewriter1_16 extends EntityRewriter<ClientboundPackets1_16, Protocol1_16To1_15_2> {
    ...
    protected void registerPackets() {
        ...
        registerMetadataRewriter(ClientboundPackets1_16.SET_ENTITY_DATA, Types1_16.METADATA_LIST, Types1_14.METADATA_LIST);
    ...
    protected void registerRewrites() {
        filter().handler((event, meta) -> {
            ...
            } else if (type == Types1_14.META_TYPES.optionalBlockStateType) {
