...
public final class BlockItemPacketRewriter1_17 extends BackwardsItemRewriter<ClientboundPackets1_17, ServerboundPackets1_16_2, Protocol1_17To1_16_4> {
    ...
    protected void registerPackets() {
        ...
        registerWindowItems(ClientboundPackets1_17.CONTAINER_SET_CONTENT);
        registerEntityEquipmentArray(ClientboundPackets1_17.SET_EQUIPMENT);
        registerTradeList(ClientboundPackets1_17.MERCHANT_OFFERS);
        registerAdvancements(ClientboundPackets1_17.UPDATE_ADVANCEMENTS);

        blockRewriter.registerAcknowledgePlayerDigging(ClientboundPackets1_17.BLOCK_BREAK_ACK);
        blockRewriter.registerBlockAction(ClientboundPackets1_17.BLOCK_EVENT);
        blockRewriter.registerEffect(ClientboundPackets1_17.LEVEL_EVENT, 1010, 2001);
